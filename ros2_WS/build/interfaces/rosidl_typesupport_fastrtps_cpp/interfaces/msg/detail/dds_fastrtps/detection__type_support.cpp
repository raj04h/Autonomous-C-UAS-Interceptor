...
#include "interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Detection & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Detection)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
